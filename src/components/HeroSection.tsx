...
export default function HeroSection() {
  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center bg-white  bg-home-pattern">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        ...
        <div className="items-center justify-items-center">
          ...
          >
            ...
            <p className="text-xl text-text-details mb-8 leading-relaxed max-w-2xl">
              Dra. Gabriela Marinho - Pediatra especializada em acompanhamento infantil.
              Consultas presenciais e online com foco no bem-estar e desenvolvimento saudável da sua criança.
            </p>
