...
import { CheckCircle, Clock, FileText, Heart, Phone, Users } from 'lucide-react';
  ...
  return (
    <section id="consultas" className="py-20 bg-gray-50 min-h-screen-offset pt-nav scroll-margin-nav">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-details mb-8 text-center">
              ...
              >
                <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-text-details text-sm leading-relaxed">
                      {step.description}
                    </p>
                  </div>
                </div>
