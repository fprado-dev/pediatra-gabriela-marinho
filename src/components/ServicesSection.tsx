  ...
  return (
    <section id="servicos" className="screen bg-ink text-on-ink">
      <div className="max-w-[1240px] w-full mx-auto px-5 sm:px-8 lg:px-20">
        <Reveal className="max-w-[46rem] mb-5 lg:mb-10">
        ...
        <Reveal delay={.15} className="flex flex-wrap items-center justify-between gap-4 mt-5 md:mt-8">
          <p className="pull text-[.95rem] md:text-xl lg:text-2xl">{services.footer}</p>
          <motion.a
            href={whatsappUrl()}
            target="_blank"
