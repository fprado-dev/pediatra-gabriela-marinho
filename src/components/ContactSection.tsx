  ...
  return (
    <section id="contato" className="py-20 bg-brand-soft min-h-screen-offset pt-nav scroll-margin-nav flex items-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <h3 className="text-xl font-bold text-details mb-6">Informações de Contato</h3>

              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <MapPin className="w-6 h-6 text-brand flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="font-semibold text-brand">Endereço</h4>
                    <p className="text-text-details">Rua das Flores, 123 - Jardim Paulista</p>
                    <p className="text-text-details">São Paulo - SP, 01415-000</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-brand">Telefone</h4>
                    <p className="text-text-details">(11) 99999-9999</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-text-details">contato@gabrielamartinho.com.br</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-brand">Horário de Atendimento</h4>
                    <p className="text-text-details">Segunda a Sexta: 8h às 18h</p>
                    <p className="text-text-details">Sábado: 8h às 12h</p>
                    <p className="text-sm text-text-details">Consultas online com horários flexíveis</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <h3 className="text-xl font-bold text-details mb-6">Agendamento Rápido</h3>
          ...
          >
            <h3 className="text-xl font-bold text-details mb-6">Formulário de Contato</h3>
        ...
        <div className="mt-12">
          <div className="bg-white rounded-xl p-6 shadow-lg">
            <h3 className="text-xl font-bold text-details mb-4">Localização</h3>
